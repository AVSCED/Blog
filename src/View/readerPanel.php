  ...
  <body>
    <!-- Top Navbar -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
        <div class="container-fluid">
          <!-- Navbar brand -->
            ...
            <img src="./assets/siteLogo.jpeg" height="48" alt="" loading="lazy"
      ...
      <div id="intro" class="p-5  text-center bg-light">
        <h1 class="mb-3 p-4 h2 text-dark fw-bold">Hello Reader Welcome To Our Blog Site</h1>
        <i class="bi bi-emoji-smile-fill text-dark h2 mb-3"></i>
      </div>
      <!-- Jumbotron -->
