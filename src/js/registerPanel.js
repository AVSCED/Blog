...
//To get a new user's details for registration
  ...
  if (new_User_Pass == new_User_CPass) {
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response == 1) {
          alert(
            "Welcome ! Your Request was submitted Successfully ,Kindly wait for Our Admin's Approval on your request. Meanwhile Read our Posted Articles"
          );
